...
### 방법 1: 실행 파일 (Python 불필요)
1. [📥 LoRaCoveragePlanner.exe](https://github.com/사용자명/레포명/releases/download/v1.0.0/LoRaCoveragePlanner.exe) 다운로드
2. [📥 data_seongnam.zip](https://github.com/사용자명/레포명/releases/download/v1.0.0/data_seongnam.zip) 다운로드
3. `data_seongnam.zip` 압축 해제 → `data/` 폴더 생성
4. `LoRaCoveragePlanner.exe` 실행
...
[📥 데이터 파일 다운로드 (data_seongnam.zip)](https://github.com/sHunjang/lora-coverage-planner/releases/tag/v1.0.0)
