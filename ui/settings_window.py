...
from PyQt5.QtWidgets import (
    ...
    QGroupBox, QComboBox, QTabWidget, QWidget, QCheckBox,
)
...
class SettingsWindow(QDialog):
    ...
    def _build(self):
        ...
        note1 = QLabel(
            ...
            "· Deygout 깊이: 1=빠름, 2=보통(기본), 3=정밀")
        note1.setStyleSheet(f"color:{MUTED};font-size:10px;")
        fl1.addRow("", note1)
        tabs.addTab(t1, "📡 전파")
        ...
        note3 = QLabel(
            ...
            "  콘크리트 1층=10~15dB, 고층=15~25dB\n"
            "· 랜덤 배치 및 새로 추가되는 Node에 적용됩니다.")
    ...
    def _collect(self) -> dict:
        return {
            ...
            "nd_indoor_loss": self.sp_nd_indoor.value(),
